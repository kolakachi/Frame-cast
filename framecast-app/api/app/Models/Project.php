...
class Project extends Model
{
    ...
    protected $fillable = [
        ...
        'assistant_brief_json',
        'character_board_json',
        'assistant_brief_locked',
        'current_revision_id',
        'family_id',
        'created_by_user_id',
        'music_asset_id',
    ...
    protected function casts(): array
    {
        return [
            ...
            'waveform_settings_json' => 'array',
            'default_voice_settings_json' => 'array',
            'generation_status_json' => 'array',
            'assistant_brief_json' => 'array',
            'character_board_json' => 'array',
            'assistant_brief_locked' => 'boolean',
            'visual_brief' => 'array',
            'series_id' => 'integer',
