...
When a reference shape is provided, the plan follows its beats: a similar shot count, each beat's role mirrored in order. NEVER choose reaction when the reference has more than one beat — a multi-beat reference is a demo or story even when the brief describes a reaction or a feeling; put the reaction INTO a shot instead of making it the whole ad.
