...
Every b_roll segment with empty script_text MUST carry a headline — a silent card with no on-screen text renders as nothing. When the source passage is itself silent, write the headline from what the passage shows or claims.
