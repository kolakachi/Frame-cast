    ...
    <div class="auth-card">
      <template v-if="state === 'sent'">
        ...
        <div class="auth-note centered">
          ...
          Didn't get it?
          <button class="auth-link auth-link-button" @click="resend">
            Resend
          </button>
        </div>

        <div class="auth-footer auth-footer-compact centered">
          <button class="auth-link auth-link-button" @click="state = 'idle'">
            ← Back to login
          </button>
        </div>
      </template>
      ...
      <template v-else>
        ...
        <p class="auth-subtitle">
          Enter your email to receive a magic link, or sign in with your
          password.
        </p>
        ...
        <form
          @submit.prevent="
            mode === 'magic' ? submitMagicLink() : submitPassword()
          "
        >
          ...
          <div v-if="mode === 'password'" class="auth-password-section">
            ...
            <button
              type="submit"
              class="auth-btn-primary auth-btn-primary-tight"
              :disabled="state === 'loading'"
            >
