---
sidebar_position: 1
title: Pick and direct a voice
description: Choose a voice, preview it, and direct how it should sound.
---

# Pick and direct a voice

Every scene is narrated by a voice you choose. The default engine is **Gemini 3.1 Flash TTS** — 30 voices, each with a gender and personality — and you can *direct* how it performs.

## 1. Open the Voice config
...
Save and the scene's voiceover regenerates with the new voice/direction.

:::tip Cost
Gemini voices cost 3 credits per scene; the legacy OpenAI voice is 1 credit.
:::

## Related

- [Clone your own voice](./clone-your-voice) — record or upload a sample (Chatterbox, 2 credits/scene).
